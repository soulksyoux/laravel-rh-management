<x-layout-app page-title="Delete colaborator">
    ...
    <div class="w-25 p-4">
        ...
        <div class="text-center">
            ...
            <a href="{{ route('rh.managment.home') }}" class="btn btn-secondary px-5">No</a>
            <a href="{{ route('rh.managment.delete-confirm-colaborator', ['id' => $colaborator->id]) }}" class="btn btn-danger px-5">Yes</a>
        </div>
